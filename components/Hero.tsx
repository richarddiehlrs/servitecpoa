...
export function Hero() {
  return (
    <section
      id="inicio"
      className="relative overflow-hidden bg-ink bg-grid-pattern bg-grid text-white"
    >
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-10 lg:px-8 lg:pt-14">
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-6 font-display text-[2.75rem] font-medium leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl">
              Consertos em
              <span className="mt-2 block text-brand-orange">eletrodomésticos</span>
              <span className="mt-3 block text-2xl font-normal text-slate-400 sm:text-3xl">
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-3xl border border-white/10 bg-ink-light/60 p-8 backdrop-blur-md lg:p-10">
              <div
                className="absolute -right-3 -top-3 h-24 w-24 rounded-full border border-brand-orange/30"
                aria-hidden
              />
        ...
        <div className="mt-12 hidden items-center gap-8 border-t border-white/10 pt-8 text-xs uppercase tracking-[0.15em] text-slate-600 sm:flex">
