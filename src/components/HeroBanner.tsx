...
export default function HeroBanner() {
  ...
  const slides = [
    {
      image: '/banner1.jpg',
      alt: 'Técnico consertando geladeira com peças originais'
    },
    {
      image: '/banner2.jpg',
      alt: 'Assistência técnica especializada em máquinas de lavar'
    },
    {
      image: '/banner3.jpg',
      alt: 'Equipe de técnicos qualificados da ServitecPoa'
    }
  ]
