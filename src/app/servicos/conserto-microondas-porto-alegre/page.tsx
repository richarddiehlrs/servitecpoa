...
export const metadata: Metadata = {
  title: 'Conserto de Microondas Porto Alegre | ServitecPoa - Especialista',
  description: 'Conserto de microondas em Porto Alegre. Especialista em reparo de fornos de microondas. Atendimento domiciliar, peças originais, garantia 90 dias. (51) 4063-8129',
  keywords: 'conserto microondas Porto Alegre, reparo microondas, conserto forno microondas, assistência técnica microondas, técnico microondas Porto Alegre, conserto microondas domicílio, peças microondas, garantia conserto microondas, microondas não aquece',
  openGraph: {
    title: 'Conserto de Microondas Porto Alegre | ServitecPoa',
    description: 'Especialista em conserto de microondas em Porto Alegre. Atendimento domiciliar, peças originais, garantia 90 dias.',
    type: 'website',
    locale: 'pt_BR',
  },
}

export default function ConsertoMicroondasPage() {
  const problemas = [
    'Não aquece',
    'Aquece pouco',
    'Fazendo barulho',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Conserto de Microondas em
              <span className="text-[#FF8C00]"> Porto Alegre</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Especialista em reparo de fornos de microondas. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="https://wa.me/555140638129?text=Olá! Preciso de conserto de microondas em Porto Alegre"
                target="_blank"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Especialistas em conserto de microondas com 15 anos de experiência
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                A melhor opção para conserto de microondas em Porto Alegre
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Conserto de microondas domiciliar em toda a cidade
              </p>
            </div>
      ...
      <section className="bg-[#1E3A5F] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Seu Microondas com Problema?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Não fique sem aquecer sua comida! Ligue agora e tenha seu microondas funcionando perfeitamente.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="tel:5140638129"
