...
export const metadata: Metadata = {
  title: 'Conserto de Máquina de Lavar Porto Alegre | ServitecPoa - Especialista',
  description: 'Conserto de máquina de lavar em Porto Alegre. Especialista em reparo de máquinas de lavar roupas, centrífugas e tanquinhos. Atendimento domiciliar, peças originais, garantia 90 dias. (51) 4063-8129',
  keywords: 'conserto máquina de lavar Porto Alegre, reparo máquina de lavar, conserto centrífuga, conserto tanquinho, assistência técnica máquina de lavar, técnico máquina de lavar Porto Alegre, conserto máquina de lavar domicílio, peças máquina de lavar, garantia conserto máquina de lavar',
  openGraph: {
    title: 'Conserto de Máquina de Lavar Porto Alegre | ServitecPoa',
    description: 'Especialista em conserto de máquina de lavar em Porto Alegre. Atendimento domiciliar, peças originais, garantia 90 dias.',
    type: 'website',
    locale: 'pt_BR',
  },
}

export default function ConsertoMaquinaLavarPage() {
  const problemas = [
    'Não centrifuga',
    'Não enche água',
    'Não drena',
    'Faz barulho excessivo',
    'Não liga',
    'Vaza água',
    'Não lava adequadamente',
    'Porta não fecha',
    'Erro no painel',
    'Não seca'
  ]
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Conserto de Máquina de Lavar em
              <span className="text-[#FF8C00]"> Porto Alegre</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Especialista em reparo de máquinas de lavar roupas, centrífugas e tanquinhos. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="https://wa.me/555140638129?text=Olá! Preciso de conserto de máquina de lavar em Porto Alegre"
                target="_blank"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Especialistas em conserto de máquina de lavar com 15 anos de experiência
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                A melhor opção para conserto de máquina de lavar em Porto Alegre
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Conserto de máquina de lavar domiciliar em toda a cidade
              </p>
            </div>
      ...
      <section className="bg-[#1E3A5F] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Sua Máquina de Lavar com Problema?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Não perca tempo! Ligue agora e tenha sua máquina de lavar funcionando perfeitamente.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="tel:5140638129"
