  ...
  const services = [
    {
      ...
      description: 'Reparo completo em geladeiras e freezers no Jardim do Salso',
      icon: '❄️',
    ...
    },
    {
      ...
      description: 'Reparo de fogões e cooktops no Jardim do Salso',
      icon: '🔥',
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: 'Excelente atendimento! Minha geladeira voltou a funcionar perfeitamente. Recomendo!'
    },
    {
      name: 'João Santos',
      service: 'Instalação de Coifa',
      rating: 5,
      comment: 'Instalação rápida e profissional. Ficou tudo perfeito!'
    }
  ]
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg shadow-lg p-8">
                <h2 className="text-2xl font-bold text-[#1E3A5F] mb-6">
                  Nossa Localização no Jardim do Salso
                </h2>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>15 anos de experiência no bairro</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-6 h-6 text-[#FF8C00]" />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Nossos Serviços no Jardim do Salso
            </h2>
