...
export const metadata: Metadata = {
  ...
  keywords: 'assistência técnica passo d areia, conserto eletrodomésticos passo d areia, técnico geladeira passo d areia, reparo máquina lavar passo d areia, instalação coifa passo d areia, porto alegre, servitecpoa'
}

export default function PassoDareiaPage() {
    const services = [
    {
      name: 'Conserto de Geladeiras',
      description: 'Reparo completo em geladeiras e freezers em Passo d&apos;Areia',
      icon: '❄️',
    ...
    },
    {
      ...
      description: 'Reparo de fogões e cooktops em Passo d&apos;Areia',
      icon: '🔥',
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Atendimento em domicílio em Passo d&apos;Areia</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#FF8C00]" />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Nossos Serviços em Passo d&apos;Areia
            </h2>
      ...
      <section className="bg-[#FF8C00] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Precisa de Assistência Técnica em Passo d&apos;Areia?
          </h2>
