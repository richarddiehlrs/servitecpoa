            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg shadow-lg p-8">
                <h2 className="text-2xl font-bold text-[#1E3A5F] mb-6">
                  Atendimento em Chácara das Pedras
                </h2>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Atendimento em domicílio em Chácara das Pedras</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#FF8C00]" />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Nossos Serviços em Chácara das Pedras
            </h2>
      ...
      <section className="bg-[#FF8C00] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Precisa de Assistência Técnica em Chácara das Pedras?
          </h2>
