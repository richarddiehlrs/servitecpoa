...
export const metadata: Metadata = {
  title: 'Conserto de Eletrodomésticos Boa Vista | Máquina de Lavar, Geladeira, Microondas',
  description: 'Conserto de eletrodomésticos em Boa Vista, Porto Alegre. Especialista em máquina de lavar, geladeira, microondas, purificador de água. Atendimento domiciliar, peças originais, garantia 90 dias. (51) 4063-8129',
  keywords: 'conserto máquina de lavar Boa Vista, conserto geladeira Boa Vista, conserto microondas Boa Vista, conserto purificador água Boa Vista, reparo eletrodomésticos Boa Vista, assistência técnica domiciliar Boa Vista, técnico eletrodomésticos Boa Vista, conserto fogão Boa Vista, conserto lava-louças Boa Vista, instalação coifa Boa Vista'
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              ...
              <span className="text-[#FF8C00]"> Boa Vista</span>
            </h1>
            <p className="text-xl mb-8 text-gray-300">
              Especialista em conserto de máquina de lavar, geladeira, microondas e purificador de água no bairro Boa Vista, Porto Alegre. 
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Atendimento em domicílio em Boa Vista</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#FF8C00]" />
      ...
      <section className="bg-[#FF8C00] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Precisa de Assistência Técnica em Boa Vista?
          </h2>
