        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              ...
              <span className="text-[#FF8C00]"> Mont&apos;Serrat</span>
            </h1>
            <p className="text-xl mb-8 text-gray-300">
              Especialista em conserto de máquina de lavar, geladeira, microondas e purificador de água no bairro Mont&apos;Serrat, Porto Alegre. 
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Atendimento em domicílio em Mont&apos;Serrat</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#FF8C00]" />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Nossos Serviços em Mont&apos;Serrat
            </h2>
      ...
      <section className="bg-[#FF8C00] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Precisa de Assistência Técnica em Mont&apos;Serrat?
          </h2>
