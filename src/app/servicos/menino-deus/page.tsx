...
export const metadata: Metadata = {
  title: 'Assistência Técnica Menino Deus | ServitecPoa - Porto Alegre',
  description: 'Assistência técnica de eletrodomésticos em Menino Deus, Porto Alegre. Conserto de geladeiras, máquinas de lavar, fogões, micro-ondas. Atendimento em domicílio, técnicos qualificados, garantia 90 dias.',
  keywords: 'assistência técnica menino deus, conserto eletrodomésticos menino deus, técnico geladeira menino deus, reparo máquina lavar menino deus, instalação coifa menino deus, porto alegre, servitecpoa'
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-300">
              Serviços especializados em eletrodomésticos no bairro Menino Deus, Porto Alegre. 
