  ...
  const services = [
    {
      ...
      description: 'Reparo completo em geladeiras e freezers em Bela Vista',
      icon: '❄️',
    ...
    },
    {
      ...
      description: 'Reparo de fogões e cooktops em Bela Vista',
      icon: '🔥',
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Atendimento em domicílio em Bela Vista</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#FF8C00]" />
      ...
      <section className="bg-[#FF8C00] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Precisa de Assistência Técnica em Bela Vista?
          </h2>
