...
export const metadata: Metadata = {
  title: 'Conserto de Lava-louças Porto Alegre | ServitecPoa - Especialista',
  description: 'Conserto de lava-louças em Porto Alegre. Especialista em reparo de lava-louças e máquinas de lavar louça. Atendimento domiciliar, peças originais, garantia 90 dias. (51) 4063-8129',
  keywords: 'conserto lava-louças Porto Alegre, reparo lava-louças, conserto máquina lavar louça, assistência técnica lava-louças, técnico lava-louças Porto Alegre, conserto lava-louças domicílio, peças lava-louças, garantia conserto lava-louças, lava-louças não lava',
  openGraph: {
    title: 'Conserto de Lava-louças Porto Alegre | ServitecPoa',
    description: 'Especialista em conserto de lava-louças em Porto Alegre. Atendimento domiciliar, peças originais, garantia 90 dias.',
    type: 'website',
    locale: 'pt_BR',
  },
}

export default function ConsertoLavaLoucasPage() {
  const problemas = [
    'Não lava',
    'Não seca',
    'Vazando água',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Conserto de Lava-louças em
              <span className="text-[#FF8C00]"> Porto Alegre</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Especialista em reparo de lava-louças e máquinas de lavar louça. 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="https://wa.me/555140638129?text=Olá! Preciso de conserto de lava-louças em Porto Alegre"
                target="_blank"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Especialistas em conserto de lava-louças com 15 anos de experiência
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Conserto de lava-louças de todas as principais marcas com peças originais
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">
                Por que Escolher a ServitecPoa para Conserto de Lava-louças?
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h4 className="text-lg font-semibold text-[#FF8C00] mb-3">🏆 Especialistas em Porto Alegre</h4>
                  <ul className="space-y-2 text-gray-700">
                    <li>• 15 anos de experiência em conserto de lava-louças</li>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                A melhor opção para conserto de lava-louças em Porto Alegre
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Conserto de lava-louças domiciliar em toda a cidade
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">
                Conserto de Lava-louças em Porto Alegre - RS
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Vamos até sua casa em qualquer bairro de Porto Alegre para conserto de lava-louças</p>
                </div>
                <div className="text-center">
                  <div className="bg-[#FF8C00] rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Todos os consertos de lava-louças possuem garantia de 90 dias</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#1E3A5F] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Sua Lava-louças com Problema?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Não fique sem lavar suas louças! Ligue agora e tenha sua lava-louças funcionando perfeitamente.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="tel:5140638129"
